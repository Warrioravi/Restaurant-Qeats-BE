...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(
       GetRestaurantsRequest getRestaurantsRequest) {
        if(!isValidCordinate(getRestaurantsRequest)){
  ...
  public boolean isValidCordinate(GetRestaurantsRequest getRestaurantsRequest){
    return  (getRestaurantsRequest.getLatitude() != null && getRestaurantsRequest.getLongitude() != null
